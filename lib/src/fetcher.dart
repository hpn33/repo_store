...
// const factory FetcherResult.data(T foo) = Data<T>;
//   const  factory FetcherResult.error() = Error<T>;
// }
...
// abstract class Fetcher<Key extends Object, Output extends Object> {
...
//          * @param flowFactory a factory for a [Flow]ing source of network records.
//          */
// static        Fetcher<Key, Output>  ofResultFlow <Key extends Object, Output extends Object>(
//             Flow<FetcherResult<Output>> Function(Key) flowFactory
//         )=> FactoryFetcher(flowFactory);
...
//          * @param doFetch a source of network records.
//          */
//       static  Fetcher<Key, Output>   ofResult<Key extends Object, Output extends Object>(
//               FetcherResult<Output> Function(Key) doFetch
//         ) => ofResultFlow(doFetch.asFlow());
...
//          * @param flowFactory a factory for a [Flow]ing source of network records.
//          */
// static     Fetcher<Key, Output>    ofFlow<Key extends Object, Output extends Object>(
//               Flow<Output> Function(Key) flowFactory
//         ) => FactoryFetcher(( Key key) {
//             flowFactory(key).map( (it) =>  FetcherResult.Data(it) as FetcherResult<Output> )
//                 .catch
